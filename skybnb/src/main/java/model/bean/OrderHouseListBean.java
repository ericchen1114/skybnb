...
public class OrderHouseListBean {
	...
	public String toString() {
		return "OrderListBean [orderHouseNumber=" + orderHouseNumber + ", sorting=" + sorting + ", memberID=" + memberID
				+ ", houseID=" + houseID + ", orderDate=" + orderDate + ", checkInDate=" + checkInDate
				+ ", checkOutDate=" + checkOutDate + ", checkoutAmount=" + checkoutAmount + ", numberOfPeople="
				+ numberOfPeople + ", cancelReservation=" + cancelReservation + ", bonus=" + bonus + ", starCount="
				+ starCount + ", comment=" + comment + ", commentStatus=" + commentStatus + "]";
	}
